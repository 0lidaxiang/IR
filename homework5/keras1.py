...
k = 2 # context windows size
context_size = 2*k
neg = 20 # number of negative samples
...
word_context_product = keras.layers.merge([word_embedding, cbow], mode='dot')
negative_context_product = keras.layers.merge([negative_words_embedding, cbow], mode='dot', concat_axis=-1)
...
# model.summary()
# model.save_weights("./save_weights.txt")
